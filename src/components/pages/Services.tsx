...
const serviceSections = [
	{
		...
		description: (
			<>
				At DataFusion, we don't just manage data—we transform it into your most
				valuable asset. Our cutting-edge Data Engineering platform creates the
				robust foundation your organization needs to thrive in today's
				data-driven economy.
			</>
		),
		bullets: [
	...
	},
	{
		...
		description: (
			<>
				Our Business Analytics platform empowers decision-makers with
				crystal-clear insights that drive growth and maximize ROI. Enable
				cross-departmental decision alignment with interactive dashboards.
			</>
		),
		bullets: [
	...
	},
	{
		...
		description: (
			<>
				Leverage cutting-edge AI technologies to predict trends and automate
				decision-making. Our proprietary neural network architecture delivers
				unparalleled accuracy across computer vision, NLP, and predictive
				analytics.
			</>
		),
		bullets: [
	...
	},
	{
		...
		description: (
			<>
				Our revolutionary Predictive Analytics platform empowers forward-thinking
				organizations to see around corners and capitalize on tomorrow's
				opportunities today. Move from hindsight to foresight and stay ahead of
				the competition.
			</>
		),
		bullets: [
	...
	},
	{
		...
		description: (
			<>
				DataFusion delivers enterprise-grade cloud infrastructure that transforms
				how your applications harness data. Integrates seamlessly with AWS,
				Azure, and Google Cloud, providing a unified control plane for your most
		...
		<main className="relative min-h-screen bg-black text-white">
			...
			<section className="w-full flex items-center justify-center h-[40vh] relative border-b border-white/10">
				...
				<div className="relative z-20 text-center px-4">
					<h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 mb-4 leading-tight pb-1">
						Our Services
					</h1>
					<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
						Explore how DataFusion transforms your data into strategic advantage
						with our full suite of consulting and technology services.
					</p>
				</div>
			</section>
				...
				>
					...
					>
						...
						<div className="flex-1 flex flex-col gap-6 md:w-3/5">
							<h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 mb-2 leading-tight pb-1">
								{service.title}
							</h2>
