...
export const SecondaryButton = ({ 
  ...
  return (
    ...
    >
      {/* Main button */}
      <div className="relative px-6 py-2.5 rounded-full bg-white text-black font-medium border border-white/10 hover:bg-white/90 transition-colors duration-300">
        {children}
      </div>
